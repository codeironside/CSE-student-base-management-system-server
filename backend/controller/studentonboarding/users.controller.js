...
//     if (!usertoken) {
//       throw Object.assign(new Error("no token"), {
//         statusCode: 404,
//       });
//     }
...
//     logger.info(
//       `User with id ${user._id} confirmed their email successfully. ${res.statusCode} - ${res.statusMessage} - ${req.originalUrl} - ${req.method} - from ${req.ip}`
//     );
//   } catch (error) {
//     throw Object.assign(new Error(`${error}`), {
